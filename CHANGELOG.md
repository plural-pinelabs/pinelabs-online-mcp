...
- Added Chocolatey distribution (`choco install pinelabs-mcp`) — thin wrapper that installs the official `pinelabs-mcp-server` from PyPI and registers a `pinelabs-mcp` shim on PATH.
